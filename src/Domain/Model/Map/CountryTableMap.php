...
use Spartan\Rest\Domain\Model\Country;
use Spartan\Rest\Domain\Model\CountryQuery;
...
class CountryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Spartan.Rest.Domain.Model.Map.CountryTableMap';
     ...
     */
    const OM_CLASS = '\\Spartan\\Rest\\Domain\\Model\\Country';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Spartan.Rest.Domain.Model.Country';
     ...
     */
    const COL_CURRENCY = 'country.currency';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Iso2', 'Continent', 'Currency', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'iso2', 'continent', 'currency', ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ID, CountryTableMap::COL_NAME, CountryTableMap::COL_ISO2, CountryTableMap::COL_CONTINENT, CountryTableMap::COL_CURRENCY, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'iso2', 'continent', 'currency', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Iso2' => 2, 'Continent' => 3, 'Currency' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'iso2' => 2, 'continent' => 3, 'currency' => 4, ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ID => 0, CountryTableMap::COL_NAME => 1, CountryTableMap::COL_ISO2 => 2, CountryTableMap::COL_CONTINENT => 3, CountryTableMap::COL_CURRENCY => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'iso2' => 2, 'continent' => 3, 'currency' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Spartan\\Rest\\Domain\\Model\\Country');
        ...
        $this->addColumn('continent', 'Continent', 'CHAR', true, 2, null);
    ...
    {
        $this->addRelation('Author', '\\Spartan\\Rest\\Domain\\Model\\Author', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':country_id',
    1 => ':id',
        ...
        $this->addRelation('Publisher', '\\Spartan\\Rest\\Domain\\Model\\Publisher', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':country_id',
    1 => ':id',
  ),
), null, null, 'Publishers', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CountryTableMap::COL_CURRENCY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Spartan\Rest\Domain\Model\Country) { // it's a model object
