...
use Spartan\Rest\Domain\Model\Book;
use Spartan\Rest\Domain\Model\BookQuery;
...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Spartan.Rest.Domain.Model.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\Spartan\\Rest\\Domain\\Model\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Spartan.Rest.Domain.Model.Book';
     ...
     */
    const COL_ISBN13 = 'book.isbn13';

    /**
     * the column name for the release_year field
     */
    const COL_RELEASE_YEAR = 'book.release_year';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Isbn13', 'ReleaseYear', 'PublisherId', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'isbn13', 'releaseYear', 'publisherId', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID, BookTableMap::COL_TITLE, BookTableMap::COL_ISBN13, BookTableMap::COL_RELEASE_YEAR, BookTableMap::COL_PUBLISHER_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'isbn13', 'release_year', 'publisher_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Isbn13' => 2, 'ReleaseYear' => 3, 'PublisherId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'isbn13' => 2, 'releaseYear' => 3, 'publisherId' => 4, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID => 0, BookTableMap::COL_TITLE => 1, BookTableMap::COL_ISBN13 => 2, BookTableMap::COL_RELEASE_YEAR => 3, BookTableMap::COL_PUBLISHER_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'isbn13' => 2, 'release_year' => 3, 'publisher_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Spartan\\Rest\\Domain\\Model\\Book');
        $this->setPackage('Spartan.Rest.Domain.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('title', 'Title', 'VARCHAR', true, 150, null);
        $this->addColumn('isbn13', 'Isbn13', 'CHAR', true, 13, null);
        $this->addColumn('release_year', 'ReleaseYear', 'INTEGER', true, null, null);
    ...
    {
        $this->addRelation('Publisher', '\\Spartan\\Rest\\Domain\\Model\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookTableMap::COL_ISBN13);
            $criteria->addSelectColumn(BookTableMap::COL_RELEASE_YEAR);
            $criteria->addSelectColumn(BookTableMap::COL_PUBLISHER_ID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.title');
            $criteria->addSelectColumn($alias . '.isbn13');
            $criteria->addSelectColumn($alias . '.release_year');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Spartan\Rest\Domain\Model\Book) { // it's a model object
