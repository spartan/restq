...
use Spartan\Rest\Domain\Model\Author;
use Spartan\Rest\Domain\Model\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Spartan.Rest.Domain.Model.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\Spartan\\Rest\\Domain\\Model\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Spartan.Rest.Domain.Model.Author';
     ...
     */
    const COL_BIRTH_DATE = 'author.birth_date';

    /**
     * the column name for the country_id field
     */
    const COL_COUNTRY_ID = 'author.country_id';

    /**
     * the column name for the status field
     */
    const COL_STATUS = 'author.status';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'FirstName', 'LastName', 'BirthDate', 'CountryId', 'Status', ),
        self::TYPE_CAMELNAME     => array('id', 'firstName', 'lastName', 'birthDate', 'countryId', 'status', ),
        self::TYPE_COLNAME       => array(AuthorTableMap::COL_ID, AuthorTableMap::COL_FIRST_NAME, AuthorTableMap::COL_LAST_NAME, AuthorTableMap::COL_BIRTH_DATE, AuthorTableMap::COL_COUNTRY_ID, AuthorTableMap::COL_STATUS, ),
        self::TYPE_FIELDNAME     => array('id', 'first_name', 'last_name', 'birth_date', 'country_id', 'status', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'BirthDate' => 3, 'CountryId' => 4, 'Status' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firstName' => 1, 'lastName' => 2, 'birthDate' => 3, 'countryId' => 4, 'status' => 5, ),
        self::TYPE_COLNAME       => array(AuthorTableMap::COL_ID => 0, AuthorTableMap::COL_FIRST_NAME => 1, AuthorTableMap::COL_LAST_NAME => 2, AuthorTableMap::COL_BIRTH_DATE => 3, AuthorTableMap::COL_COUNTRY_ID => 4, AuthorTableMap::COL_STATUS => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'first_name' => 1, 'last_name' => 2, 'birth_date' => 3, 'country_id' => 4, 'status' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Spartan\\Rest\\Domain\\Model\\Author');
        ...
        $this->addForeignKey('country_id', 'CountryId', 'TINYINT', 'country', 'id', true, null, null);
    ...
    {
        $this->addRelation('Country', '\\Spartan\\Rest\\Domain\\Model\\Country', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':country_id',
    1 => ':id',
        ...
        $this->addRelation('AuthorBook', '\\Spartan\\Rest\\Domain\\Model\\AuthorBook', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
  ),
), null, null, 'AuthorBooks', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AuthorTableMap::COL_BIRTH_DATE);
            $criteria->addSelectColumn(AuthorTableMap::COL_COUNTRY_ID);
            $criteria->addSelectColumn(AuthorTableMap::COL_STATUS);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Spartan\Rest\Domain\Model\Author) { // it's a model object
