...
use Spartan\Rest\Domain\Model\Publisher;
use Spartan\Rest\Domain\Model\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Spartan.Rest.Domain.Model.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\Spartan\\Rest\\Domain\\Model\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Spartan.Rest.Domain.Model.Publisher';
     ...
     */
    const COL_COUNTRY_ID = 'publisher.country_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'CountryId', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'countryId', ),
        self::TYPE_COLNAME       => array(PublisherTableMap::COL_ID, PublisherTableMap::COL_NAME, PublisherTableMap::COL_COUNTRY_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'country_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'CountryId' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'countryId' => 2, ),
        self::TYPE_COLNAME       => array(PublisherTableMap::COL_ID => 0, PublisherTableMap::COL_NAME => 1, PublisherTableMap::COL_COUNTRY_ID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'country_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Spartan\\Rest\\Domain\\Model\\Publisher');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Book', '\\Spartan\\Rest\\Domain\\Model\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PublisherTableMap::COL_COUNTRY_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Spartan\Rest\Domain\Model\Publisher) { // it's a model object
