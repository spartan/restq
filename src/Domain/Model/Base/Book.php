...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Spartan\\Rest\\Domain\\Model\\Map\\BookTableMap';
    ...
    /**
     * The value for the release_year field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Spartan\Rest\Domain\Model\Base\Book object.
     */
    ...
    /**
     * Get the [release_year] column value.
     *
     * @return int
     */
     ...
     * @return $this|\Spartan\Rest\Domain\Model\Book The current object (for fluent API support)
     */
    ...
    public function setIsbn13($v)
    {
        ...
        if ($this->isbn13 !== $v) {
            $this->isbn13 = $v;
            $this->modifiedColumns[BookTableMap::COL_ISBN13] = true;
        }
    ...
    /**
     * Set the value of [release_year] column.
     *
     * @param int $v new value
     * @return $this|\Spartan\Rest\Domain\Model\Book The current object (for fluent API support)
     */
    public function setReleaseYear($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->release_year !== $v) {
            $this->release_year = $v;
            $this->modifiedColumns[BookTableMap::COL_RELEASE_YEAR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BookTableMap::translateFieldName('Isbn13', TableMap::TYPE_PHPNAME, $indexType)];
            $this->isbn13 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BookTableMap::translateFieldName('ReleaseYear', TableMap::TYPE_PHPNAME, $indexType)];
            $this->release_year = (null !== $col) ? (int) $col : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Spartan\\Rest\\Domain\\Model\\Book'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BookTableMap::COL_ISBN13)) {
            $modifiedColumns[':p' . $index++]  = '`isbn13`';
        }
        if ($this->isColumnModified(BookTableMap::COL_RELEASE_YEAR)) {
            $modifiedColumns[':p' . $index++]  = '`release_year`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`isbn13`':
                        ...
                        break;
                    case '`release_year`':
                        $stmt->bindValue($identifier, $this->release_year, PDO::PARAM_INT);
                        break;
                    case '`publisher_id`':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getIsbn13(),
            $keys[3] => $this->getReleaseYear(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Spartan\Rest\Domain\Model\Book
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setIsbn13($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setReleaseYear($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Spartan\Rest\Domain\Model\Book The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookTableMap::COL_ISBN13)) {
            $criteria->add(BookTableMap::COL_ISBN13, $this->isbn13);
        }
        if ($this->isColumnModified(BookTableMap::COL_RELEASE_YEAR)) {
            $criteria->add(BookTableMap::COL_RELEASE_YEAR, $this->release_year);
        }
        if ($this->isColumnModified(BookTableMap::COL_PUBLISHER_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Spartan\Rest\Domain\Model\Book (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setReleaseYear($this->getReleaseYear());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Spartan\Rest\Domain\Model\Book Clone of current object.
     * @throws PropelException
     */
    ...
    public function setAuthorBooks(Collection $authorBooks, ConnectionInterface $con = null)
    {
        ...
        $this->authorBooksScheduledForDeletion = clone $authorBooksToDelete;

        foreach ($authorBooksToDelete as $authorBookRemoved) {
            $authorBookRemoved->setBook(null);
        }
     ...
     * @return ObjectCollection|ChildAuthorBook[] List of ChildAuthorBook objects
     */
    public function getAuthorBooksJoinAuthor(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAuthorBookQuery::create(null, $criteria);
