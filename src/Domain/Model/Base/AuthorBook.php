...
/**
 * Base class that represents a row from the 'author_book' table.
 *
 *
 *
 * @package    propel.generator.Spartan.Rest.Domain.Model.Base
 */
abstract class AuthorBook implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Spartan\\Rest\\Domain\\Model\\Map\\AuthorBookTableMap';
    ...
    /**
     * Initializes internal state of Spartan\Rest\Domain\Model\Base\AuthorBook object.
     */
    ...
    /**
     * Compares this with another <code>AuthorBook</code> instance.  If
     * <code>obj</code> is an instance of <code>AuthorBook</code>, delegates to
     * <code>equals(AuthorBook)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AuthorBook The current object, for fluid interface
     */
     ...
     * @return $this|\Spartan\Rest\Domain\Model\AuthorBook The current object (for fluent API support)
     */
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[AuthorBookTableMap::COL_AUTHOR_ID] = true;
        }
    ...
    public function setBookId($v)
    {
        ...
        if ($this->book_id !== $v) {
            $this->book_id = $v;
            $this->modifiedColumns[AuthorBookTableMap::COL_BOOK_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AuthorBookTableMap::translateFieldName('AuthorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->author_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AuthorBookTableMap::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = AuthorBookTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Spartan\\Rest\\Domain\\Model\\AuthorBook'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAuthorBookQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AuthorBook::setDeleted()
     * @see AuthorBook::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAuthorBookQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AuthorBookTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AuthorBookTableMap::COL_AUTHOR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`author_id`';
        }
        if ($this->isColumnModified(AuthorBookTableMap::COL_BOOK_ID)) {
            $modifiedColumns[':p' . $index++]  = '`book_id`';
        }

        $sql = sprintf(
            'INSERT INTO `author_book` (%s) VALUES (%s)',
    ...
    {
        $pos = AuthorBookTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['AuthorBook'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AuthorBook'][$this->hashCode()] = true;
        $keys = AuthorBookTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Spartan\Rest\Domain\Model\AuthorBook
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Spartan\Rest\Domain\Model\AuthorBook The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthorBookTableMap::COL_AUTHOR_ID)) {
            $criteria->add(AuthorBookTableMap::COL_AUTHOR_ID, $this->author_id);
        }
        if ($this->isColumnModified(AuthorBookTableMap::COL_BOOK_ID)) {
            $criteria->add(AuthorBookTableMap::COL_BOOK_ID, $this->book_id);
        }
    ...
    {
        $criteria = ChildAuthorBookQuery::create();
        $criteria->add(AuthorBookTableMap::COL_AUTHOR_ID, $this->author_id);
        $criteria->add(AuthorBookTableMap::COL_BOOK_ID, $this->book_id);
    ...
    public function hashCode()
    {
        ...
        //relation author_book_ibfk_1 to table author
        ...
        //relation author_book_ibfk_2 to table book
    ...
    {
        return (null === $this->getAuthorId()) && (null === $this->getBookId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Spartan\Rest\Domain\Model\AuthorBook (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Spartan\Rest\Domain\Model\AuthorBook Clone of current object.
     * @throws PropelException
     */
    ...
    public function getAuthor(ConnectionInterface $con = null)
    {
        if ($this->aAuthor === null && ($this->author_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthor->addAuthorBooks($this);
             */
        }
    ...
    public function getBook(ConnectionInterface $con = null)
    {
        if ($this->aBook === null && ($this->book_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBook->addAuthorBooks($this);
             */
        }
    ...
    {
        if (null !== $this->aAuthor) {
            $this->aAuthor->removeAuthorBook($this);
        }
        if (null !== $this->aBook) {
            $this->aBook->removeAuthorBook($this);
        }
        $this->author_id = null;
        $this->book_id = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(AuthorBookTableMap::DEFAULT_STRING_FORMAT);
    }
