...
use Spartan\Rest\Domain\Model\Book as ChildBook;
use Spartan\Rest\Domain\Model\BookQuery as ChildBookQuery;
use Spartan\Rest\Domain\Model\Map\BookTableMap;
 ...
 * @method     ChildBookQuery orderByIsbn13($order = Criteria::ASC) Order by the isbn13 column
 * @method     ChildBookQuery orderByReleaseYear($order = Criteria::ASC) Order by the release_year column
 ...
 * @method     ChildBookQuery groupByIsbn13() Group by the isbn13 column
 * @method     ChildBookQuery groupByReleaseYear() Group by the release_year column
 ...
 *
 * @method     ChildBookQuery leftJoinAuthorBook($relationAlias = null) Adds a LEFT JOIN clause to the query using the AuthorBook relation
 * @method     ChildBookQuery rightJoinAuthorBook($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AuthorBook relation
 * @method     ChildBookQuery innerJoinAuthorBook($relationAlias = null) Adds a INNER JOIN clause to the query using the AuthorBook relation
 *
 * @method     ChildBookQuery joinWithAuthorBook($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AuthorBook relation
 *
 * @method     ChildBookQuery leftJoinWithAuthorBook() Adds a LEFT JOIN clause and with to the query using the AuthorBook relation
 * @method     ChildBookQuery rightJoinWithAuthorBook() Adds a RIGHT JOIN clause and with to the query using the AuthorBook relation
 * @method     ChildBookQuery innerJoinWithAuthorBook() Adds a INNER JOIN clause and with to the query using the AuthorBook relation
 *
 * @method     \Spartan\Rest\Domain\Model\PublisherQuery|\Spartan\Rest\Domain\Model\AuthorBookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildBook findOneByIsbn13(string $isbn13) Return the first ChildBook filtered by the isbn13 column
 * @method     ChildBook findOneByReleaseYear(int $release_year) Return the first ChildBook filtered by the release_year column
 ...
 * @method     ChildBook requireOneByIsbn13(string $isbn13) Return the first ChildBook filtered by the isbn13 column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBook requireOneByReleaseYear(int $release_year) Return the first ChildBook filtered by the release_year column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildBook[]|ObjectCollection findByIsbn13(string $isbn13) Return ChildBook objects filtered by the isbn13 column
 * @method     ChildBook[]|ObjectCollection findByReleaseYear(int $release_year) Return ChildBook objects filtered by the release_year column
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Spartan\Rest\Domain\Model\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'rest', $modelName = '\\Spartan\\Rest\\Domain\\Model\\Book', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `title`, `isbn13`, `release_year`, `publisher_id` FROM `book` WHERE `id` = :p0';
        try {
    ...
    public function filterByIsbn13($isbn13 = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BookTableMap::COL_ISBN13, $isbn13, $comparison);
    }

    /**
     * Filter the query on the release_year column
     *
     * Example usage:
     * <code>
     * $query->filterByReleaseYear(1234); // WHERE release_year = 1234
     * $query->filterByReleaseYear(array(12, 34)); // WHERE release_year IN (12, 34)
     * $query->filterByReleaseYear(array('min' => 12)); // WHERE release_year > 12
     * </code>
     *
     * @param     mixed $releaseYear The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildBookQuery The current query, for fluid interface
     */
    public function filterByReleaseYear($releaseYear = null, $comparison = null)
    {
        if (is_array($releaseYear)) {
            $useMinMax = false;
            if (isset($releaseYear['min'])) {
                $this->addUsingAlias(BookTableMap::COL_RELEASE_YEAR, $releaseYear['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($releaseYear['max'])) {
                $this->addUsingAlias(BookTableMap::COL_RELEASE_YEAR, $releaseYear['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BookTableMap::COL_RELEASE_YEAR, $releaseYear, $comparison);
    }
     ...
     *
     * @param \Spartan\Rest\Domain\Model\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByAuthorBook($authorBook, $comparison = null)
    {
        if ($authorBook instanceof \Spartan\Rest\Domain\Model\AuthorBook) {
            return $this
                ->addUsingAlias(BookTableMap::COL_ID, $authorBook->getBookId(), $comparison);
