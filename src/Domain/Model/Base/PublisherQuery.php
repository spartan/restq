 ...
 * @method     ChildPublisherQuery orderByCountryId($order = Criteria::ASC) Order by the country_id column
 *
 ...
 * @method     ChildPublisherQuery groupByCountryId() Group by the country_id column
 *
 ...
 *
 * @method     ChildPublisherQuery leftJoinCountry($relationAlias = null) Adds a LEFT JOIN clause to the query using the Country relation
 * @method     ChildPublisherQuery rightJoinCountry($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Country relation
 * @method     ChildPublisherQuery innerJoinCountry($relationAlias = null) Adds a INNER JOIN clause to the query using the Country relation
 *
 * @method     ChildPublisherQuery joinWithCountry($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Country relation
 *
 * @method     ChildPublisherQuery leftJoinWithCountry() Adds a LEFT JOIN clause and with to the query using the Country relation
 * @method     ChildPublisherQuery rightJoinWithCountry() Adds a RIGHT JOIN clause and with to the query using the Country relation
 * @method     ChildPublisherQuery innerJoinWithCountry() Adds a INNER JOIN clause and with to the query using the Country relation
 *
 ...
 *
 * @method     \Spartan\Rest\Domain\Model\CountryQuery|\Spartan\Rest\Domain\Model\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildPublisher findOneByCountryId(int $country_id) Return the first ChildPublisher filtered by the country_id column *
 ...
 * @method     ChildPublisher requireOneByCountryId(int $country_id) Return the first ChildPublisher filtered by the country_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPublisher[]|ObjectCollection findByCountryId(int $country_id) Return ChildPublisher objects filtered by the country_id column
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Spartan\Rest\Domain\Model\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'rest', $modelName = '\\Spartan\\Rest\\Domain\\Model\\Publisher', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `country_id` FROM `publisher` WHERE `id` = :p0';
        try {
    ...
    public function filterByCountryId($countryId = null, $comparison = null)
    {
        if (is_array($countryId)) {
            ...
            if (isset($countryId['min'])) {
                $this->addUsingAlias(PublisherTableMap::COL_COUNTRY_ID, $countryId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($countryId['max'])) {
                $this->addUsingAlias(PublisherTableMap::COL_COUNTRY_ID, $countryId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublisherTableMap::COL_COUNTRY_ID, $countryId, $comparison);
    }
    ...
    public function filterByCountry($country, $comparison = null)
    {
        if ($country instanceof \Spartan\Rest\Domain\Model\Country) {
            return $this
                ->addUsingAlias(PublisherTableMap::COL_COUNTRY_ID, $country->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PublisherTableMap::COL_COUNTRY_ID, $country->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param \Spartan\Rest\Domain\Model\Book|ObjectCollection $book the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPublisherQuery The current query, for fluid interface
     */
