...
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Spartan\\Rest\\Domain\\Model\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of Spartan\Rest\Domain\Model\Base\Publisher object.
     */
     ...
     * @return $this|\Spartan\Rest\Domain\Model\Publisher The current object (for fluent API support)
     */
    ...
    public function setCountryId($v)
    {
        ...
        if ($this->country_id !== $v) {
            $this->country_id = $v;
            $this->modifiedColumns[PublisherTableMap::COL_COUNTRY_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PublisherTableMap::translateFieldName('CountryId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = PublisherTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Spartan\\Rest\\Domain\\Model\\Publisher'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->booksScheduledForDeletion !== null) {
                if (!$this->booksScheduledForDeletion->isEmpty()) {
                    \Spartan\Rest\Domain\Model\BookQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PublisherTableMap::COL_COUNTRY_ID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Spartan\Rest\Domain\Model\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Spartan\Rest\Domain\Model\Publisher The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublisherTableMap::COL_COUNTRY_ID)) {
            $criteria->add(PublisherTableMap::COL_COUNTRY_ID, $this->country_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Spartan\Rest\Domain\Model\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Spartan\Rest\Domain\Model\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCountry(ConnectionInterface $con = null)
    {
        if ($this->aCountry === null && ($this->country_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCountry->addPublishers($this);
             */
        }
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\Spartan\Rest\Domain\Model\Book');
    }
    ...
    {
        if (null !== $this->aCountry) {
            $this->aCountry->removePublisher($this);
        }
        $this->id = null;
        $this->name = null;
